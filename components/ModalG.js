...
import { Modal, Input, Row, Checkbox, Button, Text, useTheme } from "@nextui-org/react";
...
export default function ModalG() {
  ...
  return (
    <div>
      <ButtonG func={handler} color="secondary" text="Open Modal"/>
      <Modal
        closeButton
        blur
      ...
      >
        ...
        <Modal.Footer>
          {/* <Button auto style={{
              ...
              boxShadow: `0 3px 10px 0 ${theme.colors.error.value}`,
            }} onClick={closeHandler}>
            Close
          </Button>
          <Button auto style={{
              background: theme.colors.primary.value,
              boxShadow: `0 3px 10px 0 ${theme.colors.primary.value}`,
            }} onClick={handleOnSubmit}>
            Sign in
          </Button> */}
          <ButtonG func={closeHandler} color="error" text="Close"/>
          <ButtonG func={handleOnSubmit} color="primary" text="Sign In"/>
        </Modal.Footer>
      </Modal>
    </div>
  );
